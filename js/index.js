...
discord.addEventListener("click", function () {
    window.open("http://discordapp.com/users/1075008952292614157");
});

github.addEventListener("click", function () {
    window.open("https://github.com/venishaparmar");
});

codepen.addEventListener("click", function () {
    window.open("https://www.linkedin.com/in/venisha-parmar-652757222/");
});